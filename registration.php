...
Two Day Session<input name="SessionType" type="radio" value="2Day" />        Three Day Session<input name="SessionType" type="radio" value="3Day" />
...
Boy <input name="Gender" type="radio" value="Boy" />                       Girl <input name="Gender" type="radio" value="Girl" />

Right Handed<input name="DominantHand" type="radio" value="RightHand" />      Left Handed <input name="DominantHand" type="radio" value="LeftHand" />
...
One Year<input name="LengthInSchool" type="radio" value="1" />            Two Years<input name="LengthInSchool" type="radio" value="2" />
...
<input name="CheckEmail" type="checkbox" value="CheckEmail" /> Do you check email?
...
Relationship:
<input name="EmergencyRelationship" type="text" value="<?php echo $var['EmergencyRelationship']; ?>" />
...
<input name="PottyTrained" type="checkbox" value="PottyTrained" /> My child must be 3 by July 1st and is FULLY potty trained

I, <input style="width: 100px;" name="WavierName" type="text" value="<?php echo $var['WaiverName']; ?>" /> (name parent or legal gaurding), for myself and for my child, agree to all of the following.
<ol>
...
<input name="PhysicalUnaware" type="checkbox" value="checked" /> I am not aware of any physical or other condition which
may affect my child
<input name="WaiverChildNameUnware" type="text" value="<?php echo $var['WaiverChildNameUnware']; ?>" /> ability to participate in any activity at Love 4 Learning Preschool

<input name="PhysicalAware" type="checkbox" value="checked" /> I am aware my child's
<input name="WaiverChildNameAware" type="text" value="<?php echo $var['WaiverChildNameAware']; ?>" /> suffers from the following physical or other conditions
...
<input name="Bus" type="checkbox" /> My child may be taken on field trips or excursions by bus or
...
<input name="vehicle" type="checkbox" value="OnSite" /> on-site
<input name="vehicle" type="checkbox" value="OffSite" /> off-site
...
<input name="Sign" type="checkbox" value="1" /> By checking this box I agree that I have filled out this form to the best of my ability and agree with all that has been stated.
